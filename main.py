...
# ==========================================
DEFAULT_TITLES = "DC vs PBKS Epic Run Chase Live!,,Live: PBKS Chasing 265 Against DC,,DC vs PBKS High-Scoring Thriller Live Match,,IPL Action: Can PBKS Hunt Down DC's 264?,,Live Cricket: Delhi Capitals vs Punjab Kings Blockbuster"
DEFAULT_DESC = "Delhi Capitals posted a mammoth 264 on the board but Punjab Kings are striking back hard in this electrifying run chase!,,With PBKS needing 82 runs from just 40 balls the tension is peaking in this unbelievable high-scoring IPL clash,,Catch the live action as Punjab Kings battle a massive required run rate of over 12 to chase down Delhi Capitals' massive total,,It is a boundary fest out here in match 35 of the IPL as DC's explosive batting is being matched by PBKS's fearless chase,,Two heavyweights colliding in an absolute run-fest so tune in to see if PBKS can complete one of the greatest chases in IPL history"
DEFAULT_TAGS = "#DCvPBKS #IPL2024 #CricketLive #RunChase,,#DelhiCapitals #PunjabKings #TATAIPL #LiveMatch,,#PBKS #DC #IPLThrills #CricketFans,,#HighScoringMatch #IPL #CricketFever #DCvsPBKS,,#IPLT20 #LiveCricket #CricketUpdate #IPLLive"
